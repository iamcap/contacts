...
(function(process) {
  ...
  var installPackage = function(pkgName) {
    ...
    var options = {cwd: path.resolve(NODE_MODULES_DIR, '..')};
  ...
  var questions = [{
    ...
    hint: 'This should be a script that bootstraps your test by configuring Require.js and ' + 'kicking __karma__.start(), probably your test-main.js file.\n' + 'Enter empty string to move to the next question.',
    multiple: true,
    validate: validatePattern,
    condition: function(answers) {
