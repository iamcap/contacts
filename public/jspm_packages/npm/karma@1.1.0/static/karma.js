...
(function(process) {
  (function e(t, n, r) {
    ...
    7: [function(require, module, exports) {
      ...
      "../modules/_core": 19,
      "../modules/es6.array.every": 67,
      "../modules/es6.array.filter": 68,
      "../modules/es6.array.for-each": 69,
      "../modules/es6.array.index-of": 70,
      "../modules/es6.array.is-array": 71,
      "../modules/es6.array.join": 72,
      "../modules/es6.array.last-index-of": 73,
      "../modules/es6.array.map": 74,
      "../modules/es6.array.reduce": 76,
      "../modules/es6.array.reduce-right": 75,
      "../modules/es6.array.slice": 77,
      "../modules/es6.array.some": 78,
      "../modules/es6.array.sort": 79,
      "../modules/es6.date.now": 80,
      "../modules/es6.date.to-iso-string": 81,
      "../modules/es6.date.to-json": 82,
      "../modules/es6.function.bind": 83,
      "../modules/es6.number.to-fixed": 84,
      "../modules/es6.number.to-precision": 85,
      "../modules/es6.object.create": 86,
      "../modules/es6.object.define-properties": 87,
      "../modules/es6.object.define-property": 88,
      "../modules/es6.object.freeze": 89,
      "../modules/es6.object.get-own-property-descriptor": 90,
      "../modules/es6.object.get-own-property-names": 91,
      "../modules/es6.object.get-prototype-of": 92,
      "../modules/es6.object.is-extensible": 93,
      "../modules/es6.object.is-frozen": 94,
      "../modules/es6.object.is-sealed": 95,
      "../modules/es6.object.keys": 96,
      "../modules/es6.object.prevent-extensions": 97,
      "../modules/es6.object.seal": 98,
      "../modules/es6.parse-float": 99,
      "../modules/es6.parse-int": 100,
      "../modules/es6.regexp.to-string": 102,
      "../modules/es6.string.trim": 103
    }],
    ...
    105: [function(require, module, exports) {
      ...
      function serializeAttribute(node, opts) {
        return node.name + '="' + encode(node.value, extend({named: true}, opts)) + '"';
      }
    ...
    106: [function(require, module, exports) {
      ...
      var revEntities = require('./reversed.json!systemjs-json');
