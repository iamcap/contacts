...
vows.describe('log4js connect logger').addBatch({'getConnectLoggerModule': {
    topic: function() {
    ...
    'nolog String': {
      ...
      'check unmatch url request': {
        topic: function(d) {
          var req = new MockRequest('my.remote.addr', 'GET', 'http://url/hoge.png');
      ...
      'check match url request': {
        topic: function(d) {
          var req = new MockRequest('my.remote.addr', 'GET', 'http://url/hoge.gif');
          var res = new MockResponse(200);
          var cb = this.callback;
          d.cl(req, res, function() {});
          res.end('chunk', 'encoding');
    ...
    'nolog Strings': {
      ...
      'check match url request (jpeg)': {
        topic: function(d) {
          var req = new MockRequest('my.remote.addr', 'GET', 'http://url/hoge.jpeg');
          var res = new MockResponse(200);
          var cb = this.callback;
          d.cl(req, res, function() {});
          res.end('chunk', 'encoding');
