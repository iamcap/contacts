...
vows.describe('log4js-abspath').addBatch({
  'options': {
    topic: function() {
      var appenderOptions,
          log4js = sandbox.require('../lib/log4js', {requires: {'./appenders/fake': {
                name: "fake",
                appender: function() {},
      ...
      log4js.configure(config, {cwd: '/absolute/path/to'});
  ...
  'file appender': {
    topic: function() {
      var fileOpened,
          fileAppender = sandbox.require('../lib/appenders/file', {requires: {'../streams': {RollingFileStream: function(file) {
                  fileOpened = file;
                  return {
                    on: function() {},
                    end: function() {}
